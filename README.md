...
| 일자 | 학습 흐름 | 핵심 내용 |
|---|---|---|
| 1일차 | 금융상품과 계약의 기초 | 현물·선물·옵션, 콜·풋, 프리미엄·증거금, 만기·청산 |
| 2일차 | 상품 비교와 거래 구조 | 펀드·ETF·리츠·ETN, ETF 기초자산·파생상품 ETF, NAV·iNAV·괴리율, 숏 포지션, 거래소·청산기관 |
| 3일차 | 금리와 실제 거래 준비 | 채권·금리, 파생상품의 목적과 위험, 사전교육·모의거래·기본예탁금 |
| 4일차 | 위험 측정과 관리 | 분산·변동성·옵션 체인, 헤지, 증거금·마진콜·강제청산, MDD·샤프 비율 |
| 5일차 | 포트폴리오 적용 | 선물·옵션과 현물시장의 연결, 시장 심리, 자산배분·리밸런싱·LEAN 점검 |
