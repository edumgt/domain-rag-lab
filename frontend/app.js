  ...
  const THEORY_DAYS = [
    {
      ...
      goal: '저축·투자·생활 거래의 차이와, AI Hub 등 출처가 있는 문서를 RAG로 등록할 때의 기본 확인 항목을 설명할 수 있어요.',
      keywords: ['원금', '수익률', '위험', '유동성', 'AI Hub', '출처'],
      lessons: [
    ...
    },
    {
      ...
      goal: '자산배분 원칙을 적용하고, LEAN 백테스트 결과를 자신의 리밸런싱 점검에 연결할 수 있어요.',
      keywords: ['자산배분', '리밸런싱', '목표수익률', '위험허용도', '투자기간', 'LEAN'],
      lessons: [
