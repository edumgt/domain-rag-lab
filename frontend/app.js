  ...
  const THEORY_DAYS = [
    {
      ...
      lessons: [
        ...
        ['현물과 선물: 지금 거래와 미래 계약', ['현물은 지금 실제 자산을 사고파는 거래입니다. 예를 들어 주식을 사면 결제 절차를 거쳐 그 주식이 내 계좌에 들어옵니다.', '선물은 미래 가격을 지금 약속하는 계약입니다. 실제 자산을 지금 받는 대신 가격 차이를 정산하는 구조가 많습니다.', '현물은 보통 사려는 금액 전체가 필요하지만, 선물은 일부 증거금으로 거래합니다. 그래서 선물은 적은 돈으로 큰 금액에 노출될 수 있고 손익도 빠르게 커질 수 있습니다.']],
    ...
    },
    {
      ...
      goal: '펀드, ETF, 리츠, ETN의 구조와 비용·유동성·발행자 위험, ETF와 파생상품의 거래 대상 차이를 구분할 수 있어요.',
