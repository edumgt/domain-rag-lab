(function () {
  ...
  const THEORY_DAYS = [
    ...
    },
    {
      ...
      goal: '분산투자, 상관관계, 변동성, MDD, 샤프 비율과 파생상품 위험관리의 역할을 말할 수 있어요.',
      keywords: ['포지션', '포트폴리오', '헤지', '변동성 매매', '증거금', '마진콜', '상관관계', '변동성', 'MDD', '샤프 비율', '위험기여도', '집중위험'],
      lessons: [
    ...
    },
    {
      ...
      keywords: ['자산배분', '리밸런싱', '헤지', '현물시장', '선물', '옵션', '목표수익률', '위험허용도', '투자기간', 'LEAN'],
      lessons: [
