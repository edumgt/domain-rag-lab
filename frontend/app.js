(function () {
  ...
  const THEORY_DAYS = [
    ...
    },
    {
      ...
      goal: '퀀트 투자의 기본 관점과 블랙 스완을 고려한 위험관리, 분산투자, 상관관계, 변동성, MDD, 샤프 비율과 파생상품 위험관리의 역할을 말할 수 있어요.',
      keywords: ['퀀트', '퀀트 계좌', '로보어드바이저', '투자일임', '백테스팅', '노코드 퀀트', '젠포트', '퀀터스', '증권사 Open API', '모의투자', '에드워드 소프', '제임스 사이먼스', '히든 마코프 모델', 'HMM', '제로섬 게임', '블랙 스완', '회색 코뿔소', '초단타', '고빈도 알고리즘 거래', '사전 등록제', '스캘핑', '데이트레이딩', '스윙 트레이딩', '허수성 주문', '스푸핑', '최선집행', '주문정보', '페어 트레이딩', 'Z-점수', '공매도', '무차입 공매도', '포지션', '포트폴리오', '헤지', '변동성 매매', '증거금', '마진콜', '상관관계', '변동성', 'MDD', '샤프 비율', '위험기여도', '집중위험'],
      lessons: [
