(function () {
  ...
  if (day === 5) {
    addAfterText(target('자산배분은 비중을 정하는 일'), `<figure class="concept-visual"><p class="visual-kicker">ALLOCATION IS A RULE</p><div class="allocation-visual"><div class="allocation-donut" aria-label="자산별 목표 비중을 나타내는 예시 원형 그래프"></div><div class="allocation-list"><span><i></i>주식 · 성장 가능성과 큰 변동</span><span><i></i>채권 · 이자와 금리 위험</span><span><i></i>대체자산 · 다른 위험 요인</span><span><i></i>현금성 자산 · 단기 목적과 완충</span></div></div>${caption('목표 비중은 예측이 아니라 약속', '색깔과 수치는 예시입니다. 필요한 현금 시점과 손실 허용 범위에 맞춰 정합니다.')}</figure>`);
